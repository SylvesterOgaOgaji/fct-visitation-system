...
public class SampleDataLoader implements CommandLineRunner {
    ...
    private void loadOfficers(Facility facility1, Facility facility2) {
        if (officerRepository.count() == 0) {
            ...
            officer1.setName("Michael Johnson");
            officer1.setPosition("Director");
            officer1.setDepartment("Administration");
            officer1.setDutyStatus(Officer.DutyStatus.ON_DUTY);
            officer1.setEmail("michael.j@example.com");
            officer1.setPhoneNumber("08011122233");
            
            Officer officer2 = new Officer();
            officer2.setFacility(facility1);
            officer2.setName("Sarah Williams");
            officer2.setPosition("Deputy Director");
            officer2.setDepartment("Human Resources");
            officer2.setDutyStatus(Officer.DutyStatus.ON_DUTY);
            ...
            officer3.setName("David Brown");
            officer3.setPosition("Manager");
            officer3.setDepartment("Operations");
            officer3.setDutyStatus(Officer.DutyStatus.ON_DUTY);
    ...
    private void loadCheckpoints() {
        if (checkpointRepository.count() == 0) {
            ...
            checkpoint1.setLocationName("Main Entrance");
            checkpoint1.setDescription("Main gate of the facility");
            checkpoint1.setFacility(defaultFacility);
            
            Checkpoint checkpoint2 = new Checkpoint();
            checkpoint2.setLocationName("Reception");
            checkpoint2.setDescription("Reception area");
            checkpoint2.setFacility(defaultFacility);
            
            Checkpoint checkpoint3 = new Checkpoint();
            checkpoint3.setLocationName("Security Office");
            checkpoint3.setDescription("Security clearance point");
            checkpoint3.setFacility(defaultFacility);
