...
--changeset author:fct-visitation:2
-- Facilities
...
('Adekunle Ogunleye', 'aogunleye', '$2a$10$EqKCjGBKQHSQwi8X7v/5p.Tl9.CZpSjf4eP4ILrVr0gMUBDW2v87W', 'SUPERVISOR', '08056789012'),
('Grace Johnson', 'gjohnson', '$2a$10$8A/R8kg1cTuJpG7oWV20JOX7Kx8e9KrRGN1M19vZKyudQiloUG2vW', 'GUARD', '08056789013'),
('Michael Taiwo', 'mtaiwo', '$2a$10$HF87t1cO2WM1q0NUFDs.ReOEPAC8XpVZa8/NZ/Md6WpG84tJSTxny', 'GUARD', '08056789014');
...
(1, 'admin', '$2a$10$h.dl5J86rGH7I8bD9bZeZeci0pDt0.VwvxhvgE4Lm4DA.ZIn0UZHK', 'ADMIN', 'System Administrator', 'admin@fct.gov.ng', '08078901234'),
(2, 'healthadmin', '$2a$10$m.Od.ImZYfLoq0Z5vBzieegGmeaWMHG33LeIooKh.WFEWVoQXJLFC', 'SUB_ADMIN', 'Health Admin', 'healthadmin@fct.gov.ng', '08078901235'),
(3, 'ministeradmin', '$2a$10$XIqYjY8a/FWCYeJF/PVJseXZQzQk/7uqXxE2fAiVjpKrJcY9xAUfW', 'SUB_ADMIN', 'Minister Office Admin', 'ministeradmin@fct.gov.ng', '08078901236');
